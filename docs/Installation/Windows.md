...
- Download: [Stirling-PDF-server.exe](https://files.stirlingpdf.com/win-server.exe)
- Anyone on your network can access it
- No user accounts needed

**With Login (User Management):**
- Download: [Stirling-PDF-server-with-login.exe](https://files.stirlingpdf.com/win-server-with-login.exe)
