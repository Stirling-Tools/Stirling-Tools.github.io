...
> **Looking for OAuth 2.0 SSO?** See [OAuth SSO Configuration](./OAuth%20SSO%20Configuration.md) (free on every plan).
...
- [External Database](../Storage/External%20Database.md) - User storage configuration
