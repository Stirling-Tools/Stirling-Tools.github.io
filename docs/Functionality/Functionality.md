...
- Add/Remove Password
- Change Permissions
- **[Sign](./Security/Sign.md)** - Handwritten signatures
- **[Certificate Sign](./Security/Certificate-Signing.md)** - Digital signatures
- Validate Signature
- Add Watermark
- Sanitize PDF
- Auto-Redact
...
**Detailed Guide:** [Redaction](./Page-Operations/redact.md)
...
- Make searchable → **[OCR](./OCR.md)**
- Combine files → **Merge**
- Split into parts → **Split**
- Convert format → **[Convert](./Convert/Convert.md)**
